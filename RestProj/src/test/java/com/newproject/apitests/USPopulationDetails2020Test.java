...
public class USPopulationDetails2020Test { // New class name for 2020 data
    ...
    public void setupRequestSpecification() {
        ...
        // Step 3 & 5: Create/Overwrite Request Specification method for the URI with Year=2020
        requestSpec = RestAssured.given()
                ...
                .queryParam("year", "2020") // Set year parameter to 2020
                .log().all(); // Log all request details for debugging
    }

    @Test
    public void getUSPopulationDetails2020() {
        System.out.println("\n--- Sending GET request for US Population details for 2020 ---");

        // Step 6: Send GET request using the Request Specification
        ...
        System.out.println("\n--- US Population Details for 2020 ---");
