...
public class USPopulationDetailsResponseSpec2020Test { // New class name for 2020 data
    ...
    public void setupResponseSpecification() {
        ...
        // Step 3 & 5: Create/Overwrite Response Specification method for status code and Content type as JSON
        // This specification will be applied to the response for the year 2020 data.
    ...
    @Test
    public void getUSPopulationDetails2020AndValidateResponseSpec() {
        ...
        try {
            ...
            response = RestAssured.given()
                    ...
                    .queryParam("year", "2020") // Query for year 2020
            ...
            // Assuming we are interested in the first entry in the data array for 2020 US population
            Map<String, Object> populationDetails = data.get(0);

            System.out.println("\n--- US Population Details for 2020 (from Response) ---");
            ...
            Assert.assertEquals(idYear, Integer.valueOf(2020), "Expected ID Year to be 2020");
            ...
            System.out.println("\nUS Population details retrieval and verification successful for 2020!");
