...
public class GetMultipleHeadersPost { // New class for getting response with multiple headers and POST

    @Test
    public void getResponseWithMultipleHeadersAndPost() {
        ...
        // Perform the POST request with multiple headers and request body
        Response response = RestAssured.given()
                .header("Content-Type", "application/json") // First header
                .header("Accept", "application/json")       // Second header
        ...
        System.out.println("\nAPI response with multiple headers and POST method validated successfully!");
    }
}
