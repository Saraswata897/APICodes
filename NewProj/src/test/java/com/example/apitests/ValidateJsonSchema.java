...
import static io.restassured.module.jsv.JsonSchemaValidator.matchesJsonSchemaInClasspath; // Import JsonSchemaValidator

import java.io.IOException;
import java.io.InputStream;
import java.nio.charset.StandardCharsets;

public class ValidateJsonSchema { // New class for validating JSON schema

    @Test
    public void validateBookingResponseJsonSchema() {
        ...
        // The schema file (booking_response_schema.json) must be in src/test/resources/
        response.then().assertThat().body(matchesJsonSchemaInClasspath("booking_response_schema.json"));
